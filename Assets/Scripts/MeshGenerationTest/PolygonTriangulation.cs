...
{
    [SerializeField] private List<Vector2> vertices2D;
    [SerializeField] private float _randomPointsCircleRadius;
    ...
    void Update()
    {
        ...
        {
            GenerateRandomPoints(_pointsToGenerate);
    ...
    private void GenerateRandomPoints(int count)
    {
        for (int i = 0; i < count; i++)
        {
            ...
            vertices2D.Add(new Vector2(point.CurrentPosition.x, point.CurrentPosition.z));
        }
    }
}
